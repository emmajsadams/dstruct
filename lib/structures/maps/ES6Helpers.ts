...
export class Iterator<E> implements Interfaces.Iterator<E> {
    private currentEntry:Entry<any, any>;
    private done = false;

    constructor(private iterator:Interfaces.Iterator<Entry<any, any>>, private valueCallback:(entry:Entry<any, any>) => any) {
    }
