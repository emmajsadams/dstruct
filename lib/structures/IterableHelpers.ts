...
export function equals<E extends Interfaces.IBaseObject>(iterable: Interfaces.IIterable<E>, otherIterable: Interfaces.IIterable<E>): boolean {
...
export function forEach<E extends Interfaces.IBaseObject>(iterable: Interfaces.IIterable<E>, callback: Interfaces.IForEachCollectionCallback<E>): void {
  Error.checkNotNull(iterable);
